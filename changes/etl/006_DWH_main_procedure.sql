CREATE OR REPLACE PROCEDURE RIS_DWH.DWH_MAIN_CJH_1_PROCEDURE (
        START_DATE IN DATE
    ) IS
    ...
    v_pin_to         NUMBER;
    BEGIN
        SELECT MAX(PIN) INTO v_pin_from FROM RIS_DWH.WT_CV_JOB_HISTORY_1;
